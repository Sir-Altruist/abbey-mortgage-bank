        ...
        <Grid container>
            ...
            <Grid item xs={12} md={5}>
                ...
                <span style={{ paddingRight: '1rem'}}>
                   ...
                   <Typography color={'textSecondary'} sx={{ pr: 1.5}}>Filter</Typography>
                   <span style={{ paddingRight: '1rem'}}>
                   <SearchIcon color="action" />
                   </span>
                   <div style={{ marginTop: '-.5rem'}}>
                       <Button variant="contained" className='status-btn' sx={{ textTransform: 'inherit', backgroundColor: teal['A700']}} startIcon={<AddIcon />}>New Projects</Button>
                   </div>
                </div>
            </Grid>
        </Grid>
